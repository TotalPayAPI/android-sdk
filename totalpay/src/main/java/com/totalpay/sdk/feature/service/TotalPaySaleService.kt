...
/**
 * SALE Service for the [com.totalpay.sdk.feature.adapter.TotalPaySaleAdapter].
 ...
 */
interface TotalPaySaleService {

    /**
     * Perform SALE request.
     *
     * @param url the [com.totalpay.sdk.core.TotalPayCredential.PAYMENT_URL].
     * @param action the [com.totalpay.sdk.model.api.TotalPayAction.SALE].
    ...
    fun sale(
        ...
        orderAmount: String,
        @NonNull
        @Size(TotalPayValidation.Text.CURRENCY)
        ...
        @NonNull
        @Size(min = TotalPayValidation.Card.CVV_MIN, max = TotalPayValidation.Card.CVV_MAX)
        @Field("card_cvv2")
        cardCvv2: String,
        @NonNull
        ...
        @NonNull
        @Size(TotalPayValidation.Text.COUNTRY)
        @Field("payer_country")
        payerCountry: String,
        @Nullable
        @Size(max = TotalPayValidation.Text.SHORT)
