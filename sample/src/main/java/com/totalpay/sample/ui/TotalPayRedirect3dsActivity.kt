...
import com.totalpay.sample.databinding.ActivityRedirect3dsBinding

class TotalPayRedirect3dsActivity : AppCompatActivity(R.layout.activity_redirect_3ds) {
    ...
    companion object {
        ...
        fun open(context: Activity, termUrl: String, termUrl3ds: String) {
            context.startActivityForResult(
                Intent(context, TotalPayRedirect3dsActivity::class.java).apply {
