...
/**
 * GET_TRANS_STATUS Service for the [com.totalpay.sdk.feature.adapter.TotalPayGetTransactionStatusAdapter].
 * @see TotalPayGetTransactionStatusResponse
 *
 * Gets order status from Payment Platform.
 */
interface TotalPayGetTransactionStatusService {

    /**
     * Perform GET_TRANS_STATUS request.
     *
     * @param url the [com.totalpay.sdk.core.TotalPayCredential.PAYMENT_URL].
     * @param action the [com.totalpay.sdk.model.api.TotalPayAction.GET_TRANS_STATUS].
     ...
     * @return the [Call] by [TotalPayGetTransactionStatusResponse].
     */
    @FormUrlEncoded
    @POST
    fun getTransactionStatus(
        ...
        @Field("hash")
        hash: String,
    ): Call<TotalPayGetTransactionStatusResponse>
}
