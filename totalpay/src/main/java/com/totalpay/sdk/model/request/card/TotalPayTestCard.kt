...
object TotalPayTestCard {
     ...
     */
    val SALE_SUCCESS = TotalPayCard(TEST_CARD_NUMBER, 1, TEST_CARD_EXPIRE_YEAR, TEST_CARD_CVV)
     ...
     */
    val SALE_FAILURE = TotalPayCard(TEST_CARD_NUMBER, 2, TEST_CARD_EXPIRE_YEAR, TEST_CARD_CVV)
     ...
     */
    val CAPTURE_FAILURE = TotalPayCard(TEST_CARD_NUMBER, 3, TEST_CARD_EXPIRE_YEAR, TEST_CARD_CVV)
     ...
     */
    val SECURE_3D_SUCCESS = TotalPayCard(TEST_CARD_NUMBER, 5, TEST_CARD_EXPIRE_YEAR, TEST_CARD_CVV)
     ...
     */
    val SECURE_3D_FAILURE = TotalPayCard(TEST_CARD_NUMBER, 6, TEST_CARD_EXPIRE_YEAR, TEST_CARD_CVV)
}
